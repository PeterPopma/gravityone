...
namespace WinFormsGraphicsDevice
{
    ...
    class GraphicsDeviceService : IGraphicsDeviceService
    {
        ...
        public void ResetDevice(int width, int height)
        {
            ...
            parameters.BackBufferWidth = width;// Math.Max(parameters.BackBufferWidth, width);
            parameters.BackBufferHeight = height;// Math.Max(parameters.BackBufferHeight, height);
